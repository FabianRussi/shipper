    ...
    )
    {
        ...
        return	{
            ...
            ,	mountToApp: function (application)
            {
                ...
                if (SC.ENVIRONMENT.CURRENTINVENTORY)
                {
                    profile_model_instance.get('currentinventory').reset(SC.ENVIRONMENT.CURRENTINVENTORY);
                    delete SC.ENVIRONMENT.CURRENTINVENTORY;
                }
                else
                {
