	...
	,	getFulfillments: function ()
		{
			...
			,	columns = [
				...
				,	new nlobjSearchColumn('otherrefnum','fulfillingtransaction')
			...
			Application.getAllSearchResults('salesorder', filters, columns).forEach(function (ffline)
			{
				...
				// try{
				// 	nlapiLogExecution("DEBUG","OTHER BEFORE","other ref before")
				// 	self.result.otherrefnum = ffline.getValue('otherrefnum')
				// 	nlapiLogExecution("DEBUG","OTHER AFTTER======::::---",self.result.otherrefnum)
				// }catch(e){
				// 	nlapiLogExecution("DEBUG","OTHER BEFORE",e)
				// }
